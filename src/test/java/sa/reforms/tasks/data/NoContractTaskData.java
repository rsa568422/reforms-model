...
public class NoContractTaskData extends TaskData {
    ...
    public static NoContractTask NO_CONTRACT_TASK_A() {
        NoContractTask task = new NoContractTask(GET_PRICE_A(), GET_DEFAULT_DESCRIPTION_A());
        task.setStatus(GET_STATUS_A());
        return task;
    }

    public static NoContractTask NO_CONTRACT_TASK_B() {
        NoContractTask task = new NoContractTask(GET_PRICE_B(), GET_DEFAULT_DESCRIPTION_B());
